...
public class Network {
    ...
    private static final String CONDITION_USERS = "-conditionUsers"; // + msg
...
//            start
    ...
    public void sendMessage(String message) {
        try {
            if (message.equals(END_CLIENT_CMD_PREFIX)) {
                out.writeUTF(String.format("%s", END_CLIENT_CMD_PREFIX));
            }
                ...
                while (true) {
                    ...
                    switch (typeMessage) {
                        ...
                        case SERVER_MSG_CMD_PREFIX -> {
                            ...
                            if (parts[1].equals(CONDITION_USERS)) {
